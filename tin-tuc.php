                ...
                <div class="left-content">
                    <div class="shadow p-lg mb-xlg">
                        ...
                        <div class="body-about">
                            <img src="<?= base_url() ?>/public/uploads/tin-tuc/<?= $new['p_thunbar'] ?>" alt="" class="img-body-about" style="width: 180px;">
                            <div class="child-right">
                                <a href="chi-tiet-tin-tuc.php?id=<?= $new['id'] ?>&<?= $new['p_slug'] ?>.html"><p class="title-child-about"> <?= $new['p_title'] ?></p></a>
                                <p class="text-why"> <?= $new['p_descriptions'] ?> </p>
                            </div>
                        </div>
                        <?php endforeach;?>
                    </div>
...
<script type="text/javascript">
    ...
    function update_day_count(){
        ...
        //     $interval = 1;
        // }
        let $sale = Number('<?php echo isset($dsproductId["sale"]) ? $dsproductId["sale"] : 0; ?>');
        let $price = Number('<?php echo isset($dsproductId["price"]) ? $dsproductId["price"] : 0; ?>');
